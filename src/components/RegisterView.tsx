...
import { Mail, Lock, User, Eye, EyeOff, Calculator, AlertCircle, ArrowRight, CheckCircle2 } from 'lucide-react';
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const newUser = {
        ...
        email,
        password,
        image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face' // Default fallback profile pic
      };

      users.push(newUser);
      localStorage.setItem('trp_users', JSON.stringify(users));
        ...
        <div className="bg-gradient-to-br from-[#0f172a] to-[#1e293b] dark:from-[#0b0f19] dark:to-[#111827] p-8 md:p-12 text-white flex flex-col justify-between relative overflow-hidden border-r border-[#1e293b] dark:border-slate-800">
          <div className="relative z-10">
            ...
            <div className="space-y-4 max-w-sm">
              ...
              <p className="text-slate-400 text-sm leading-relaxed font-sans">
                Create a high-security store manager credential to operate standard, clean point-of-sale systems with live bento metrics.
              </p>
            </div>
          </div>
          ...
          <div className="relative z-10 mt-12 bg-white/5 border border-white/10 p-5 rounded-2xl backdrop-blur-md">
            ...
            <div className="flex items-end justify-between">
              <div>
                <span className="text-xs text-slate-400">Encryption Active</span>
                <p className="text-sm font-semibold font-sans mt-0.5 text-white">SHA-256 State Hashing</p>
              </div>
              <span className="text-xs px-2.5 py-1 bg-sky-500/20 text-sky-400 font-bold rounded-lg">
                Compliant
              </span>
            </div>
          </div>
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm mt-1.5">
                Register a secure manager profile for your store branch
              </p>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold uppercase text-slate-500 dark:text-slate-400 tracking-wider mb-1.5 font-mono">
                  Full Name
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-2.5 bg-slate-50 dark:bg-[#151f32] border border-slate-100 dark:border-slate-800 rounded-xl text-sm font-semibold text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-12 py-2.5 bg-slate-50 dark:bg-[#151f32] border border-slate-100 dark:border-slate-800 rounded-xl text-sm font-semibold text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 bg-[#0f172a] hover:bg-[#1e293b] dark:bg-sky-500 dark:hover:bg-sky-400 text-white dark:text-slate-950 font-bold text-sm rounded-xl transition-all shadow-lg shadow-slate-100 dark:shadow-sky-500/5 active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer mt-4"
              >
                {isLoading ? (
            ...
            <p className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
              ...
              <Link to="/login" className="font-bold text-[#0f172a] dark:text-sky-400 hover:underline">
                Sign In
              </Link>
            </p>
